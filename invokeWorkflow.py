...
PROJECT_ENDPOINT = "https://foundry-changju-v3.services.ai.azure.com/api/projects/proj-default"
WORKFLOW_NAME = "Sequential-Workflow"
WORKFLOW_VERSION = "2"  # Update this if you have a different version
